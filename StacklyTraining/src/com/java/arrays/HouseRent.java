...
public class HouseRent {
	public static void main(String[] args) {
		...
		while(isTrue) {
			...
			rentReceipt(scan,rent1bhk,"1 BHK");
			break;
			case 2: float rent2bhk=12000;
			rentReceipt(scan,rent2bhk,"2 BHK");
			break;
			case 3: float rent3bhk=18000;
			rentReceipt(scan,rent3bhk,"3 BHK");
			break;
			case 4: float villa =25000;
			rentReceipt(scan,villa,"Villa");
			break;
	...
	public static void rentReceipt(Scanner scan,float rent,String type) {
